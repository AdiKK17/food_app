  ...
  void _showConfirmDialog(int index) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            "You want to unfollow ${Provider.of<Auth>(context).usersDataDetails[index].name}?"),
        actions: <Widget>[
          FlatButton(
          ...
          FlatButton(
            onPressed: () {
              ...
              Provider.of<Auth>(context).deleteFriends(
                  index,
        ...
        itemBuilder: (context, index) => Column(
          children: <Widget>[
            ListTile(
              ...
              title:
                  Text(Provider.of<Auth>(context).usersDataDetails[index].name),
              subtitle: Text(
                  Provider.of<Auth>(context).usersDataDetails[index].email),
              trailing: Provider.of<Auth>(context)
                      .usersDataDetails[index]
                      .isFriend
                  ? FlatButton(
                      color: Colors.white,
